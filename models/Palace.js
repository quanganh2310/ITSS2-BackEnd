...
let fakePalace =  [
    ...
    },
    {
        ...
        "image": "https://toplist.vn/images/800px/lotte-cinema-landmark-218326.jpg",
        "description": "Nằm khá xa trung tâm nhưng Lotte Cinema Landmark vẫn cực kì hút khách bởi cụm rạp chiếu phim này nằm trong tòa nhà KeangNam Landmark – tòa nhà cao nhất Hà Nội. Được xây dựng theo công nghệ của người Hàn Quốc nên không có gì lạ khi Lotte Cinema mang đậm phong cách Hàn Quốc với lối thiết kế sang trọng, với những phòng chờ, quầy bán vé đa dạng, trang thiết bị được đầu tư hiện đại.",
        "vote": 5
    },
    {
        "id": 22,
